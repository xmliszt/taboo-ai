...
export function HomeMenuButton({
  ...
  return (
    <div className='group relative rounded-lg shadow-lg transition-all ease-in-out hover:scale-105 hover:cursor-pointer'>
      ...
      ></div>
      <div className='rotating-mono-border-trace absolute left-0 top-0 -z-10 h-full w-full rounded-lg opacity-0 transition-[transform_opacity_0.3s_ease-in-out] after:blur-lg group-hover:opacity-100'></div>
    </div>
  );
}
