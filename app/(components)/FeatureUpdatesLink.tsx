...
const FeatureUpdatesLink = () => {
  ...
  return (
    <>
      <Link
        className={`${
          whatsnewVisible ? 'visible' : 'invisible'
        } absolute left-[60%] -top-10 lg:-top-12 text-base lg:text-2xl text-yellow dark:text-neon-yellow animate-fade-inout-first-loop hover:text-red-light hover:dark:text-neon-red transition-colors ease-in-out`}
        href='/whatsnew'
