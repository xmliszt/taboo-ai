...
export default function HomePage(props: HomePageProps) {
  ...
  const isServiceDown = Boolean(process.env.CHATGPT_OUTAGE);

  return (
    <>
      {isServiceDown ? (
        <section className='flex justify-center items-center text-3xl leading-normal h-full w-full'>
          OpenAI API is experiencing unexpected outage. We will be back once the
          outage from OpenAI has been resolved! Thank you for your patience!
        </section>
      ) : (
